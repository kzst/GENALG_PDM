...
%allocation for a resource constraint hybrid continouos time-quality-cost
%trade-off problem (RCHCTQCTP)
...
%---------------- 
%Usage:
%PSM=hpmgencqr(PDM,const,typefcn)
%---------------- 
%Example:
...
%tic;PSM=hpmgencqr(PDM,const,typefcn);toc
%---------------- 
...
function PSM=hpmgencqr(PDM,const,typefcn)
...
%    'HybridFcn',@fmincon,'CrossoverFcn',@crossoverhybridcqr,...
...
chromosome=ga(@targetfcncqr,n+2*N,[],[],[],[],LB,UB,...
