...
%----------------
%Subfunction for Crossover of resource-constrained HDTCTPs 
%----------------
%Output:
%chromosome=Recombined gene sequences
%---------------- 
%Inputs:
%DSM1: N by N binary uppertriangle matrix of parent1's logic domain
...
%DSM2: N by N binary uppertriangle matrix of parent2's logic domain
...
%---------------- 
%Usage:
%chromosome=crossdsmdr(DSM1,MODES1,SST1,DSM2,MODES2,SST2)
%---------------- 
%Example:
...
function chromosome=crossdsmdr(DSM1,MODES1,SST1,DSM2,MODES2,SST2)
global P T
...
lout1=isfeasibledr(DSM1,MODES1,SST1); %Feasibility check of parent1
lout2=isfeasibledr(DSM2,MODES2,SST2); %Feasibility check of parent2
