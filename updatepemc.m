...
%----------------
%Output:
%PSM: An N by N+1 PSM=[DSM,MODES] matrix, where
% DSM is an N by N upper triangular binary matrix of the calculated logic
% domain
% MODES(=T) is an N by 1 column vector of completion modes 
%----------------
%Input:
%chromosome: row vector of decision values
%----------------
%Usage:
%PSM=updatepemc(chromosome)
%----------------
%Example:
...
function PSM=updatepemc(chromosome)
...
PSM=[round(PEM),chromosome(nA+1:n)'];