...
%---------------- 
%Usage:
%PDM=generatepdmq_gpu(N,ff,cf,mTD,mCD,mRD,w,nR,nW)
%---------------- 
%Example:
%PDM=generatepdmq_gpu(30,0.05,0,20,30,20,2,2,2)

function PDM=generatepdmq_gpu(N,ff,cf,mTD,mCD,mRD,w,nR,nW)
cf=cf+1;
