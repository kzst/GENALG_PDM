...
%----------------
%Calculate CR=TPRmin+R%*(TPRmax-TPRmin) when quality parameters are not
%considered
%----------------
%Output:
...
function CR=percentr(PDM,w,ratio)
