...
%----------------
%Create population for HCTCTPs and HCTQCTPs and Pareto-Optimal 
%Resource Allocation
%----------------
%Standard output:
...
%---------------- 
%Usage:
%Population=createpemc(GenomeLength, FitnessFcn, options)
%---------------- 
%Example:
...
function Population=createpemc(GenomeLength, FitnessFcn, options)
global P T
%global values: 
