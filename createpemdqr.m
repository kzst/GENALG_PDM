...
%----------------
%Create population for resource constrained HDTCTPs and HDTQCTPs
%----------------
%Standard output:
...
%---------------- 
%Usage:
%Population=createpemdqr(GenomeLength, FitnessFcn, options)
%---------------- 
%Example:
...
function Population= createpemdqr(GenomeLength, FitnessFcn, options)
global P T
%global values: 
