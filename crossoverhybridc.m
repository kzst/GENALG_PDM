...
%----------------
%Crossover function for HCTCTPs and Pareto-Optimal Resource Allocation
%----------------
%Standard output:
...
%---------------- 
%Usage:
%xoverKids  = crossoverhybridc(parents,options,GenomeLength,FitnessFcn,...
...
function xoverKids  = crossoverhybridc(parents,options,GenomeLength,...
...
for i=1:nKids
    ...
    xoverKids(i,:)=crossdsmc(DSM1,MODES1,DSM2,MODES2);
end
