...
%----------------
%Subfunction for Crossover of resource-constrained HCTCTPs 
%----------------
%Output:
...
%---------------- 
%Usage:
%chromosome=crossdsmcr(DSM1,MODES1,SST1,DSM2,MODES2,SST2)
%---------------- 
%Example:
...
function chromosome=crossdsmcr(DSM1,MODES1,SST1,DSM2,MODES2,SST2)
global P % N by N upper triangle score matrix of completion
chromosome=[];
lout1=isfeasiblecr(DSM1,MODES1,SST1); %Feasibility check of parent1
lout2=isfeasiblecr(DSM2,MODES2,SST2); %Feasibility check of parent2
