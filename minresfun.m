...
%----------------
%Calculate minimum resource demands
%----------------
%Output:
%rMIN: is an nR by 1 vector of minimum resource demands
%---------------- 
%Inputs:
...
%rMIN=minresfun(EST,DSM,T,R) %Clculate minimum resource demands for the
%       %three resources
%---------------- 
...
function rMIN=minresfun(SST,DSM,T,R)
