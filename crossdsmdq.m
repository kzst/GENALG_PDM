...
%----------------
%Subfunction for Crossover of HDTQCTPs and Pareto-Optimal Resource 
%Allocation
%----------------
%Output:
...
%---------------- 
%Usage:
%chromosome=crossdsmdq(DSM1,MODES1,DSM2,MODES2)
%---------------- 
%Example:
...
function chromosome=crossdsmdq(DSM1,MODES1,DSM2,MODES2)
global P T
%Global variables:
...
lout1=isfeasibledq(DSM1,MODES1); %Feasibility check of parent1
lout2=isfeasibledq(DSM2,MODES2); %Feasibility check of parent2
