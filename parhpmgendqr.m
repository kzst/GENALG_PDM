...
%allocation for a hybrid multi-objective multi-mode resource constraint
%project scheduling problem with quality (HMOMRCPSP(q)) by hybrid genetic 
%algorithm 
%----------------
%Output:
...
%tic;PSM=parhpmgendqr(PDM,const);toc
%---------------- 
...
function PSM=parhpmgendqr(PDM,const)
...
X=gamultiobj(@targetfcndqrpar,n+2*N,[],[],[],[],LB,UB,@constrainrtpardqr,options);
