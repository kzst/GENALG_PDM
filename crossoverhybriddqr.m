...
%----------------
%Crossover function for resource-constrained HDTQCTPs
%----------------
%Standard output:
...
%---------------- 
%Usage:
%xoverKids = crossoverhybriddqr(parents,options,GenomeLength,FitnessFcn,...
...
function xoverKids  = crossoverhybriddqr(parents,options,GenomeLength,...
...
for i=1:nKids
    ...
    xoverKids(i,:)=crossdsmdqr(DSM1,MODES1,SST1,DSM2,MODES2,SST2);
end