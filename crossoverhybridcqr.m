...
%----------------
%Crossover function for resource-constrained HCTQCTPs
%----------------
%Standard output:
...
%---------------- 
%Usage:
%xoverKids = crossoverhybridcqr(parents,options,GenomeLength,FitnessFcn,...
...
function xoverKids  = crossoverhybridcqr(parents,options,GenomeLength,...
...
for i=1:nKids
    ...
    xoverKids(i,:)=crossdsmcqr(DSM1,MODES1,SST1,DSM2,MODES2,SST2);
end
