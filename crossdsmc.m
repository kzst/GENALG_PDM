...
%----------------
%Subfunction for Crossover of HCTCTPs and Pareto-Optimal Resource 
%Allocation
%----------------
%Output:
...
%---------------- 
%Usage:
%chromosome=crossdsmc(DSM1,MODES1,DSM2,MODES2)
%---------------- 
%Example:
...
function chromosome=crossdsmc(DSM1,MODES1,DSM2,MODES2)
global P % N by N upper triangle score matrix of logic domain
chromosome=[];
lout1=isfeasiblec(DSM1,MODES1); %Feasibility check of parent1
lout2=isfeasiblec(DSM2,MODES2); %Feasibility check of parent2
