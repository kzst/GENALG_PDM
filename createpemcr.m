...
%----------------
%Create population for resource constrained HCTCTPs and HCTQCTPs
%----------------
%Standard output:
...
%---------------- 
%Usage:
%Population=createpemcr(GenomeLength, FitnessFcn, options)
%---------------- 
%Example:
...
function Population= createpemcr(GenomeLength, FitnessFcn, options)
global P T
%global values: 
