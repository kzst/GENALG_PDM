...
%Hybrid Discrete Time-Quality-Cost Trade-off Problems (rc-HDTQCTP)
%----------------
%Standard output:
...
%---------------- 
%Usage:
%target=targetfcndqr(chromosome)
%---------------- 
%Example:
...
function targets=targetfcndqrpar(chromosome)
global P Q T C q R Ct Cc CR Cq Cs QD
%global variables: 
...
targets=[-tpqs+c',tpts+c',tpcs+c',-(maxscore_PEM_cell(A,P,Q)'*100+maxscore_SNPM_cell(A,P,Q)'),UF+c'];